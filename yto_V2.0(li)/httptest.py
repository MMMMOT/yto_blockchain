...
r = requests.get("http://112.65.156.58:9000/v2/odata/datapoints?$filter=DeviceNumber eq '000000004' and dpCreationTime gt 2018-11-08T17:46:50%2B08:00&$orderby=dpCreationTime desc")
#rjs = r.json() 
#rlist = rjs['value']
#rdict = rlist[1]
#print(rdict)
